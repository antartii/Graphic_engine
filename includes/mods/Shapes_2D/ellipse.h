...
class Ellipse
{
    ...
    public :
        Ellipse() {};
        Ellipse(Coordinates center, float radius[2]);
        ...
        void set_radius(unsigned int index, float radius); // TODO
        void set_center(Coordinates center); // TODO 
        void compute_vp(void);

        static std::vector<Coordinates> compute_points(Coordinates center, float radius[2]);
};
